...
if ( !isset($_POST["name"]) || !isset($_POST["email"]) || !isset($_POST["phone"]) || !isset($_POST["mensaje"]) ) {
...
$emailDestino = "elasdelfratachobrc@gmail.com"; //elasdelfratachobrc@gmail.com (dirección de destino Pepe.)
...
$mail->Subject = "Mensaje del sitio web www.elasdelfratacho.com"; // Este es el titulo del email.
