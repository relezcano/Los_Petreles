...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="backend.php">Selección de Comentarios</a></li>
      <li><a href="coments_shown.php">Comentarios Publicados</a></li>
    </ul>
  </div>
</nav>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="row">
          ...
          <div class="col-md-1"><button type="submit" name="publish" class="btn btn-success btn-form display-2">Publicar</button></div>
          <div class="col-md-1"><button type="submit" name="delete" class="btn btn-danger btn-form display-2">Borrar</button></div>
          <div class="col-md-5"></div>
        </div>
