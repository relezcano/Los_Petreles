...
<body style="background-image: url(../assets/images/mar.jpg); background-attachment: fixed; background-repeat: round">
  ...
  <div class="container" style="background-color: black; opacity: 0.8; border-radius: 50px; padding-bottom: 10px">
  <form name="ingresar" action="../include/session_check.php" method="post">
      ...
      <div class="row" style="margin-top: 10px">
        <div class="col-md-4"></div>
          <div class="col-md-4">
            <div class="input-group">
              <span class="input-group-addon" id="basic-addon1" style="color: white; margin-top: 5px"><b>Contraseña</b></span>
      ...
      <div class="row">
        ...
        <div class="col-md-2">
          <button type="submit" name="ingresar" style="color: black; border-radius: 10px; background-color: #4dff4d"><span class="glyphicon glyphicon-log-in"> <strong>Ingresar</strong></span></button>
